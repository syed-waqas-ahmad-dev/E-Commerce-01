...
async function reduceInventory(items: any[]): Promise<void> {
...
async function createOrderItems(orderId: string, items: any[]): Promise<void> {
...
async function updateOrderStatus(
  ...
  await createOrderItems(order.id, order.items);
